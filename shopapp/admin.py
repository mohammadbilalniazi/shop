...
#from shopapp.models import Log,Customer,Customer_kahatha_received,Product,Bill_detail,Bill,Roznamcha,Initial_asset,Sale_bill,Sales_detail
...
admin.site.site_header=format_html("<a href='/admin'><h1 style='color:rgb(255, 174, 0); font-weight:bold; text-align:center; font-size:40px'>Shirkat</h1></a>")
...
class SaleAdmin(admin.ModelAdmin): 
    list_display=("payment","sale_date","vendor","customer","total_sale_bill","discount")
