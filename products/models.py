...
# from purchase.views_bill import findOrganization
# def findorg(self):
...
class Product(models.Model):
    ...
    # img=models.ImageField(upload_to = 'Products/y/m/d',null=True,blank=True,validators=[validate_image])
    img=models.ImageField(upload_to = Category_directory_path,null=True,blank=True)
...
class Product_Price(models.Model):
    ...
    previous_purchased_price=models.DecimalField(default=0,max_digits=22, decimal_places=2,null=True)
    selling_price=models.DecimalField(default=0,max_digits=22, decimal_places=2,null=True)
    previous_selling_price=models.DecimalField(default=0,max_digits=22, decimal_places=2,null=True)
